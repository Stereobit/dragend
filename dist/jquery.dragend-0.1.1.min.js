...
this.settings.onSwipeStart(container,this.activeElement);this._scrollToPage(a)},updateInstance:function(a){"object"===typeof a&&c.extend(this.settings,a);this.page=this.settings.jumpToPage||this.settings.scrollToPage||this.page;this._sizePages()}});c.fn.dragend=function(a){var b=this.data("dragend");b?b.updateInstance(a):(b=new e(this,a),this.data("dragend",b));"string"===typeof a&&b.swipe(a);return this}})(jQuery,window);
