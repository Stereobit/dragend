(function(f){function l(e,m){var n=function(){},l={pageClass:"dragend-page",direction:"horizontal",minDragDistance:"40",onSwipeStart:n,onSwipeEnd:n,onDrag:n,onDragEnd:n,keyboardNavigation:!1,itemsInPage:1,scribe:0,borderBetweenPages:0,duration:300,hammerSettings:{drag_min_distance:0,css_hacks:!1,prevent_default:!0}},q={37:"left",38:"up",39:"right",40:"down"},r={overflow:"hidden",padding:0},k=function(a,b){var c,d;for(c in b)if(b.hasOwnProperty(c)){d=b[c];switch(c){case "height":case "width":case "marginLeft":case "marginTop":d+=
"px"}a.style[c]=d}},g=function(a,b){for(var c in b)a[c]=b[c];return a},h=function(a,b){return function(){return a.apply(b,Array.prototype.slice.call(arguments))}},s=function(a,b,c,d,g){var k=+new Date,f=parseInt(a.style[b],10),h=setInterval(function(){var e=+new Date-k;e>=d?(e=c,g(),clearInterval(h)):e=Math.round((c-f)*(Math.floor(100*(e/d))/100)+f);a.style[b]=e+"px"},5)},t=function(){var a=document.createElement("div"),b=["Khtml","Ms","O","Moz","Webkit"],c=b.length;return function(d){if(d in a.style)return!0;
for(d=d.replace(/^[a-z]/,function(a){return a.toUpperCase()});c--;)if(b[c]+d in a.style)return!0;return!1}}(),p=function(a,b){var c=g({},l);this.settings=g(c,b);this.container=a;this.pageContainer=document.createElement("div");this.scrollBorder={x:0,y:0};this.page=0;this.preventScroll=!1;this.pageCssProperties={margin:0};this.pageContainer.innerHTML=this.container.innerHTML;this.container.innerHTML=null;this.container.appendChild(this.pageContainer);k(this.container,r);this._observe();f.setTimeout(h(function(){this.updateInstance(b)},
this),10)},u=function(a){"horizontal"===this.settings.direction?k(this.pageContainer,{"-webkit-transform":"translateX("+a.x+"px)","-moz-transform":"translateX("+a.x+"px)","-ms-transform":"translateX("+a.x+"px)","-0-transform":"translateX("+a.x+"px)",transform:"translateX("+a.x+"px)"}):"vertical"===this.settings.direction&&k(this.pageContainer,{"-webkit-transform":"translateY("+a.y+"px)","-moz-transform":"translateY("+a.y+"px)","-ms-transform":"translateY("+a.y+"px)","-o-transform":"translateY("+a.y+
"px)",transform:"translateY("+a.y+"px)"})},w=function(){k(this.pageContainer,{"-webkit-transition":"-webkit-transform "+this.settings.duration+"ms ease-out","-moz-transition":"-moz-transform "+this.settings.duration+"ms ease-out","-ms-transition":"-ms-transform "+this.settings.duration+"ms ease-out","-o-transition":"-o-transform "+this.settings.duration+"ms ease-out",transition:"transform "+this.settings.duration+"ms ease-out"});this._scroll({x:-this.scrollBorder.x,y:-this.scrollBorder.y});f.setTimeout(h(v,
this),this.settings.duration)},v=function(){this._onSwipeEnd();k(this.pageContainer,{"-webkit-transition":"-webkit-transform 0"})},x=function(){var a,b;this.activeElement=this.pages[this.page*this.settings.itemsInPage];"horizontal"===this.settings.direction?(a="marginLeft",b=-this.scrollBorder.x):"vertical"===this.settings.direction&&(a="marginTop",b=-this.scrollBorder.y);s(this.pageContainer,a,b,this.settings.duration,h(this._onSwipeEnd,this))};(function(){var a,b;t("transform")?(a=u,b=w):(a=_scrollWithoutTransform,
b=x);g(p.prototype,{_scroll:a,_animateScroll:b})})();g(p.prototype,{_checkOverscroll:function(a,b,c){var d={x:b,y:c,overscroll:!0};switch(a){case "right":if(!this.scrollBorder.x&&this._checkGestureDirection(a))return Math.round(d.x=(b-this.scrollBorder.x)/5),d;break;case "left":if((this.pagesCount-1)*this.pageDimentions.width<=this.scrollBorder.x)return d.x=Math.round(-((Math.ceil(this.pagesCount)-1)*(this.pageDimentions.width+this.settings.borderBetweenPages))+b/5),d;break;case "down":if(!this.scrollBorder.y&&
this._checkGestureDirection(a))return d.y=Math.round((c-this.scrollBorder.y)/5),d;break;case "up":if((this.pagesCount-1)*this.pageDimentions.height<=this.scrollBorder.y)return d.y=Math.round(-((Math.ceil(this.pagesCount)-1)*(this.pageDimentions.height+this.settings.borderBetweenPages))+c/5),d}return{x:b-this.scrollBorder.x,y:c-this.scrollBorder.y,overscroll:!1}},_observe:function(){if(!m)throw Error("It seems like Hammer JS is not be included before dragend JS");(new m(this.container,this.settings.hammerSettings)).on("drag",
h(this._onDrag,this)).on("dragend",h(this._onDragend,this));m.event.bindDom(f,"resize",h(this._sizePages,this));this.settings.keyboardNavigation&&m.event.bindDom(document.body,"keydown",h(this._onKeydown,this))},_onDrag:function(a){var b;a.stopPropagation();if(a.gesture)a=a.gesture,b=this._checkOverscroll(a.direction,a.deltaX,a.deltaY),this.settings.onDrag.call(this,this.activeElement,a,b.overscroll);else throw Error("Dragend JS detected some problems with the event handling. Maybe the user-drag CSS attribute on images can help");
...
this.page)},_onKeydown:function(a){(a=q[a.keyCode])&&this._scrollToPage(a)},_checkGestureDirection:function(a){if(("left"===a||"right"===a)&&"horizontal"===this.settings.direction||("up"===a||"down"===a)&&"vertical"===this.settings.direction)return!0},setHorizontalContainerCssValues:function(){g(this.pageCssProperties,{cssFloat:"left",overflowY:"auto",overflowX:"hidden",padding:0,display:"block"});k(this.pageContainer,{overflow:"hidden",width:(this.pageDimentions.width+this.settings.borderBetweenPages)*
this.pagesCount,boxSizing:"content-box","-webkit-backface-visibility":"hidden","-webkit-perspective":1E3,margin:0,padding:0})},setVerticalContainerCssValues:function(){g(this.pageCssProperties,{overflow:"hidden",padding:0,display:"block"});k(this.pageContainer,{"padding-bottom":this.settings.scribe,boxSizing:"content-box","-webkit-backface-visibility":"hidden","-webkit-perspective":1E3,margin:0})},setContainerCssValues:function(){switch(this.settings.direction){case "horizontal":this.setHorizontalContainerCssValues();
...
(function(f){function l(e,m){var n=function(){},l={pageClass:"dragend-page",direction:"horizontal",minDragDistance:"40",onSwipeStart:n,onSwipeEnd:n,onDrag:n,onDragEnd:n,keyboardNavigation:!1,itemsInPage:1,scribe:0,borderBetweenPages:0,duration:300,hammerSettings:{drag_min_distance:0,css_hacks:!1,prevent_default:!0}},q={37:"left",38:"up",39:"right",40:"down"},r={overflow:"hidden",padding:0},k=function(a,b){var c,d;for(c in b)if(b.hasOwnProperty(c)){d=b[c];switch(c){case "height":case "width":case "marginLeft":case "marginTop":d+=
"px"}a.style[c]=d}},g=function(a,b){for(var c in b)a[c]=b[c];return a},h=function(a,b){return function(){return a.apply(b,Array.prototype.slice.call(arguments))}},s=function(a,b,c,d,e){var g=+new Date,f=parseInt(a.style[b],10),k=setInterval(function(){var h=+new Date-g;h>=d?(h=c,e(),clearInterval(k)):h=Math.round((c-f)*(Math.floor(100*(h/d))/100)+f);a.style[b]=h+"px"},5)},t=function(){var a=document.createElement("div"),b=["Khtml","Ms","O","Moz","Webkit"],c=b.length;return function(d){if(d in a.style)return!0;
for(d=d.replace(/^[a-z]/,function(a){return a.toUpperCase()});c--;)if(b[c]+d in a.style)return!0;return!1}}(),p=function(a,b){var c=g({},l);this.settings=g(c,b);this.container=a;this.pageContainer=document.createElement("div");this.scrollBorder={x:0,y:0};this.page=0;this.preventScroll=!1;this.pageCssProperties={margin:0};this.pageContainer.innerHTML=this.container.innerHTML;this.container.innerHTML=null;this.container.appendChild(this.pageContainer);k(this.container,r);this._observe();f.setTimeout(h(function(){this.updateInstance(b)},
this),10)},u=function(a){"horizontal"===this.settings.direction?k(this.pageContainer,{"-webkit-transform":"translateX("+a.x+"px)","-moz-transform":"translateX("+a.x+"px)","-ms-transform":"translateX("+a.x+"px)","-0-transform":"translateX("+a.x+"px)",transform:"translateX("+a.x+"px)"}):"vertical"===this.settings.direction&&k(this.pageContainer,{"-webkit-transform":"translateY("+a.y+"px)","-moz-transform":"translateY("+a.y+"px)","-ms-transform":"translateY("+a.y+"px)","-o-transform":"translateY("+a.y+
"px)",transform:"translateY("+a.y+"px)"})},w=function(){k(this.pageContainer,{"-webkit-transition":"-webkit-transform "+this.settings.duration+"ms ease-out","-moz-transition":"-moz-transform "+this.settings.duration+"ms ease-out","-ms-transition":"-ms-transform "+this.settings.duration+"ms ease-out","-o-transition":"-o-transform "+this.settings.duration+"ms ease-out",transition:"transform "+this.settings.duration+"ms ease-out"});this._scroll({x:-this.scrollBorder.x,y:-this.scrollBorder.y});f.setTimeout(h(v,
this),this.settings.duration)},v=function(){this._onSwipeEnd();k(this.pageContainer,{"-webkit-transition":"-webkit-transform 0"})},x=function(){var a,b;this.activeElement=this.pages[this.page*this.settings.itemsInPage];"horizontal"===this.settings.direction?(a="marginLeft",b=-this.scrollBorder.x):"vertical"===this.settings.direction&&(a="marginTop",b=-this.scrollBorder.y);s(this.pageContainer,a,b,this.settings.duration,h(this._onSwipeEnd,this))};(function(){var a,b;t("transform")?(a=u,b=w):(a=_scrollWithoutTransform,
